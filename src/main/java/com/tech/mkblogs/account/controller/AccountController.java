...
public class AccountController {
	...
	@PutMapping("/account")
	public ResponseEntity<ResponseDTO<AccountDTO,ErrorObject>> updateAccount(@RequestBody AccountDTO accountDTO) {
	...
	@GetMapping("/account")
	public ResponseEntity<ResponseDTO<List<AccountDTO>,ErrorObject>> getAllAccounts() {
		log.info(" getAllAccounts() method ");
	...
	public ResponseEntity<ResponseDTO<List<AccountDTO>,ErrorObject>> search(@RequestParam("accountName") String name,
